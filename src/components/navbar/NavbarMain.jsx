...
const NavbarMain = () => {
  ...
  return (
   <nav className='max-w-[1300px] mx-auto px-4 w-full fixed left-[50%] -translate-x-[50%] z-20 flex gap-4 mt-2'>
    <div className=' flex justify-between items-center w-full max-w-[1200px] mx-auto bg-black p-6 rounded-r-full rounded-l-full border-[0.5px] border-orange'>
      <NavbarLogo />
    ...
    <div className='flex lg:hidden sm:block p-6 bg-black items-center justify-center rounded-full border-[0.5px] border-orange'>
        <button className='text-xl p-3 border border-orange rounded-full text-white' onClick={toggleMenu}>
            <GiHamburgerMenu />
        </button>
    </div>
   </nav>
